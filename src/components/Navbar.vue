...
<nav id="nav" class="links" :class="{ active: isActive}">
    ...
    <router-link @click="toggleNav" to="/">Home</router-link>
     <router-link @click="toggleNav" :to="{ name: 'SignUp'}">SignUp</router-link>
    ...
    <!-- <router-link @click="toggleNav" :to="{ name: ''}">Projects</router-link> -->
    <!-- <router-link @click="toggleNav" :to="{ name: ''}"></router-link> -->
